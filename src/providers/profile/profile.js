...
let ProfileProvider = class ProfileProvider {
    ...
    importWallet(str, opts) {
        return new Promise((resolve, reject) => {
            ...
            if (!strParsed.n) {
                return reject('Backup format not recognized.');
            }
    ...
    addAndBindWalletClient(wallet, opts) {
        return new Promise((resolve, reject) => {
            ...
            // this.askToEncryptWallet(wallet).then(() => {  // if u need to prompt user for password on registration, just uncomment this line 
