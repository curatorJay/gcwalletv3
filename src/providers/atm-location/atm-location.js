...
/*
  ...
  and Angular DI.
*/
let AtmLocationProvider = class AtmLocationProvider {
    constructor(http, platform, logger, locationTracker) {
        this.http = http;
    ...
    getLocationsPromise(geoObj, api) {
                            ...
                            this.http
                                ...
                                if (res === null) {
                                    ...
                                    for (let data of this.results) {
                                        var distCal = this.getDistance({ lat: data['lat'], lng: data['lng'] }, geoObj);
                                ...
                                this.logger.warn(err, ': Could not retrieve location data.');
                                this.results = null;
                                reject(this.results);
                            });
                        }
        ...
        //** If there is no geolocation, then no point or way in showing "closest" location, so show the error */
            ...
            this.logger.warn('Your Geolocation is not working. Please enable geolocation to see your closest locations near you.');
...
AtmLocationProvider = __decorate([
    Injectable(),
...
export { AtmLocationProvider };
//# sourceMappingURL=atm-location.js.map