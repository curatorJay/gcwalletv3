...
describe('Release Provider', () => {
    ...
    it('should get successfully the latest app version', () => {
        ...
        const githubReq = httpMock.expectOne('https://api.github.com/repos/getcoinscom/gcwallet/releases/latest');
    ...
    it('should check unsuccessfully the latest app version format', () => {
        const result = releaseService.checkForUpdates('V..3.3.3', currentAppVersion);
        expect(result.updateAvailable).toBeNull;
        expect(result.availableVersion).toBeNull;
        expect(result.error).toBeDefined();
        expect(result.error).toMatch('Cannot');
    ...
    it('should be a new version available', () => {
        const result = releaseService.checkForUpdates(latestAppVersion, currentAppVersion);
        expect(result.error).toBeNull;
    ...
    it('should be a new major version available', () => {
        ...
        const result = releaseService.checkForUpdates(majorAppVersion, currentAppVersion);
        expect(result.error).toBeNull;
        expect(result.updateAvailable).toBeTruthy;
    ...
    it('should be a new minor version available', () => {
        ...
        const result = releaseService.checkForUpdates(minorAppVersion, currentAppVersion);
        expect(result.error).toBeNull;
        expect(result.updateAvailable).toBeTruthy;
    ...
    it('should be a new patch version available', () => {
        ...
        const result = releaseService.checkForUpdates(patchAppVersion, currentAppVersion);
        expect(result.error).toBeNull;
        expect(result.updateAvailable).toBeTruthy;
