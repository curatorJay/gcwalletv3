...
describe('Provider: TouchId Provider', () => {
    ...
    describe('Function: check', () => {
        it('should verify iOS device has Fingerprint', () => {
            ...
            const spy = spyOn(touchId, 'verifyFingerprint').and.returnValue(Promise.resolve());
        ...
        it('should verify Android device has Fingerprint', () => {
            ...
            const spy = spyOn(androidFingerprintAuth, 'encrypt').and.returnValue(Promise.resolve({ withFingerprint: true }));
            touchIdProvider.check();
...
//# sourceMappingURL=touchid.spec.js.map