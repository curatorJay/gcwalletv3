...
describe('TransactionsPage', () => {
    ...
    let instance;
    let testBed;
    beforeEach(async(() => TestUtils.configurePageTestingModule([TransactionsPage]).then(testEnv => {
    ...
    describe('Lifecycle Hooks', () => {
        describe('ionViewWillEnter', () => {
            ...
            it('should not break if address book list call fails', () => {
                spyOn(testBed.get(AddressBookProvider), 'list').and.returnValue(Promise.reject('bad error'));
                instance.ionViewWillEnter();
            });
        });
