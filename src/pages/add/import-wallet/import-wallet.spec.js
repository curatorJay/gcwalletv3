...
describe('ImportWalletPage', () => {
    ...
    describe('Function: normalizeMnemonic', () => {
        ...
        describe('Function called with words', () => {
            it('should return words list normalized', () => {
                const nonNormalizedWords = 'mom  mom mom           mom mom mom mom mom mom mom mom mom';
                expect(instance.normalizeMnemonic(nonNormalizedWords)).toEqual('mom mom mom mom mom mom mom mom mom mom mom mom');
            });
        });
    });
    ...
    describe('Function: importFromFile', () => {
        ...
        it('should return if has not backupFile and backupText', () => {
            ...
            instance.importForm.controls['derivationPath'].setValue(info.derivationPath);
