    ...
    describe('Lifecycle Hooks', () => {
        ...
        describe('ionViewDidLoad', () => {
            it('should log debug info', () => {
                ...
                expect(instance.logger.info).toHaveBeenCalledWith('ionViewDidLoad SessionLogPage');
            });
        });
    });
    describe('Methods', () => {
        ...
        describe('#prepareLogs', () => {
            it('should return correct log', () => {
                ...
                expect(log).toEqual('GetCoins Session Logs\n Be careful, this could contain sensitive private data\n\n\n\n[01/07/2008][1]msg');
            });
        });
        describe('#sendLogs', () => {
            it('should send logs', () => {
                ...
                instance.sendLogs();
                expect(instance.socialSharing.shareViaEmail).toHaveBeenCalledWith('logs', 'GetCoins Logs', null, null, null, null);
            });
        });
        ...
        describe('#showWarningModal', () => {
            it('should create warning modal', () => {
                const popupProvider = testBed.get(PopupProvider);
