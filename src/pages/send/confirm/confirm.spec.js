...
describe('ConfirmPage', () => {
    ...
    describe('Methods', () => {
        ...
        describe('approve', () => {
            ...
            const txp = { coin: 'BTC' };
            const wallet = {};
            it('should clear the ongoing process loader if user declines', () => __awaiter(this, void 0, void 0, function* () {
            ...
            it('should publish and sign upon approval', () => __awaiter(this, void 0, void 0, function* () {
                spyOn(instance, 'getTxp').and.returnValue(Promise.resolve(txp));
        ...
        describe('onlyPublish', () => {
            it('should open the finish modal on success', () => __awaiter(this, void 0, void 0, function* () {
            ...
            it('should set send error on failure', () => __awaiter(this, void 0, void 0, function* () {
